    ...
    <section id="about" className="py-20 sm:py-28 bg-neo-cream grid-bg relative overflow-hidden text-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          {/* Bio card */}
          <div className="lg:col-span-3 neo-border bg-card p-8 neo-shadow-lg neo-card-hover">
            ...
            <div className="flex items-center gap-2 neo-border-thin px-4 py-2 bg-neo-secondary inline-block">
